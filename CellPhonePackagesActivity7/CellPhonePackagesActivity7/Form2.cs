...
{
    public partial class FormIndividualPlan : Form
    {

        /*Author: Gustavo Marin Borges
         Title: CellPhonePackages:IndividualPlan*/

        public FormIndividualPlan()
        {
            InitializeComponent();
        }
        ...
        {       
            ...
            TotalArray[5] = TotalMonthlyCharge;
